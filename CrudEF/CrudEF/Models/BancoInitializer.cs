...
{
    public class BancoInitializer:CreateDatabaseIfNotExists<BancoContext>
    {
        protected override void Seed(BancoContext context)
        {
            ...
            sucursales.ForEach(s => context.Sucursal.AddOrUpdate(s));
            ...
            empleados.ForEach(e => context.Empleado.AddOrUpdate(e));
            context.SaveChanges();
            ...
            cuentas.ForEach(c => context.Cuenta.AddOrUpdate(c));
            context.SaveChanges();
        }
